          ...
          <table class="table fs--1 mb-0 border-top border-200">
            <thead>
              <tr>
                ...
                <th class="sort align-middle ps-3" scope="col" data-sort="assigness" style="width:10%;">actuator</th>
                <th class="sort align-middle ps-3" scope="col" data-sort="start" style="width:10%;">User</th>
            ...
            <tbody class="list" id="project-list-table-body">
              ...
              <td class="align-middle time white-space-nowrap ps-0 projectName py-4">
                <div class="avatar-group avatar-group-dense">
                    <a class="dropdown-toggle dropdown-caret-none d-inline-block" href="{{route('user.show',['id'=>$item['User_action']['id']])}}" role="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
                      <div class="avatar avatar-s  rounded-circle">
                        <img class="rounded-circle "
                        title="{{$item['User_action']['name']}}"
                        src="{{(!is_null($item['User_action']['image']))?asset("storage/".$item['User_action']['image']):asset("storage/logos/inconnue.jpeg")}}" alt="">
                      </div>
                      <span>
                        {{$item['User_action']['name']}}
                      </span>
                    </a>
                  </div>
            </td>
